...
exports.cadastrarProfessor = (req, res) => {
    ...
    const comando = `INSERT INTO PROFESSOR (nome, materia, disponivel) VALUES
    ($1, $2, $3);`
...
exports.atualizarProfessor = (req, res) => {
    ...
    const comando = `UPDATE PROFESSOR SET nome = $1,  materia = $2, disponivel = $3, WHERE id = $4;`
...
exports.excluirProfessor = (req, res) => {
    const idDoPostman = req.params.id;
    const comando = `DELETE FROM PROFESOR WHERE id = $1;`
